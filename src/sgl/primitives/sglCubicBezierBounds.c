/** FILE DESCRIPTION -------------------------------------------------------
 FILENAME          : sglCubicBezierBounds.c
...
/*+ FUNCTION DESCRIPTION ----------------------------------------------
  ...
  RETURN:
    None
---------------------------------------------------------------------+*/
void sglCubicBezierBounds(SGLfloat par_f_prev_x, SGLfloat par_f_prev_y, SGLfloat par_f_x1, SGLfloat par_f_y1, SGLfloat par_f_x2, SGLfloat par_f_y2,
                          SGLfloat par_f_x, SGLfloat par_f_y, SGLfloat * par_pf_x1, SGLfloat * par_pf_y1, SGLfloat * par_pf_x2, SGLfloat * par_pf_y2)
{
    if ((par_pf_x1 != SGL_NULL) && (par_pf_y1 != SGL_NULL) && (par_pf_x2 != SGL_NULL) && (par_pf_y2 != SGL_NULL)) {
        ...
        loc_ul_nb_segments = oglx_cubic_bezier_points(&loc_p_p0, &loc_p_p1, &loc_p_p2, &loc_p_p3);
        ...
        oglxSetError(SGL_ERROR_SGL_CUBICBEZIERBOUNDS, 0U);
    }
