...
/*+ DEFINITION OF CONSTANTS -------------------------------------------------------
 DESCRIPTION       : Definition of constants of sglGetArcSegmentBounds.c
 LLR: [OGLX-DDD-sglGetArcSegmentBounds_constants]
---------------------------------------------------------------------------- +*/
#define OGLX_NE 0UL
#define OGLX_NW 1UL
#define OGLX_SW 2UL
...
---------------------------------------------------------------------+*/
SGLbool sgl_get_arc_segment_bounds_detect_error(SGLbool par_b_clockwise, SGLfloat par_f_angle, SGLfloat * par_pf_x1, SGLfloat * par_pf_y1, SGLfloat * par_pf_x2,
                                                SGLfloat * par_pf_y2)
{
...
{
    SGLbool loc_b_error_detected = sgl_get_arc_segment_bounds_detect_error(par_b_clockwise, par_f_angle, par_pf_x1, par_pf_y1, par_pf_x2, par_pf_y2);
