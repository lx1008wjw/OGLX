...
/*+ FUNCTION DESCRIPTION ----------------------------------------------
  NAME: oglx_get_rich_text_bounds
  DESCRIPTION:
...
---------------------------------------------------------------------+*/
sgl_bounding_box oglx_get_rich_text_bounds(SGLfloat par_f_x, SGLfloat par_f_y, const SGLbyte * par_pb_string,
                                           SGLulong par_ui_string_length, SGLfloat par_f_hor_alignment, SGLfloat par_f_vert_alignment)
{
    ...
    SGLbool loc_b_first_bounds_value = SGL_TRUE;
    SGLfloat loc_f_min_x = 0.0F;
    SGLfloat loc_f_max_x = 0.0F;
    sgl_bounding_box loc_s_return;
    sgl_rich_text_attr loc_text_attr;
    SGLulong loc_ul_nb_lines = 0UL;
    SGLfloat loc_f_tmp;

    loc_text_attr.f_width = 0.0F;
    loc_text_attr.f_height = 0.0F;
    loc_text_attr.ui_index = 0UL;
    loc_text_attr.l_back_color = -1;
    loc_text_attr.l_fore_color = -1;
    loc_text_attr.b_activated_lines = 0U;
    loc_text_attr.ui_last_char = 0U;
    loc_text_attr.b_frame_started = SGL_FALSE;
    loc_text_attr.b_outline_started = SGL_FALSE;
    loc_text_attr.f_max_underline = -100.0F;
    loc_text_attr.f_min_stroke = 100.0F;
    loc_text_attr.f_max_vert_advance = 0.0F;
    loc_text_attr.ui_param_font_id = 0U;
    loc_text_attr.b_reverse_video = SGL_FALSE;
    loc_text_attr.us_line_number = 0U;
    loc_text_attr.b_cr_started = SGL_FALSE;
    loc_text_attr.l_rev_color = -1;

    loc_text_attr.ui_current_font_id = glob_pr_sglStatemachine->ui_current_font_id;
    loc_text_attr.p_current_font = glob_pr_sglStatemachine->p_current_font;

    /* Set length */
    loc_text_attr.ui_counter = (GLint) par_ui_string_length;
    loc_text_attr.pb_string = par_pb_string;
    loc_text_attr.us_index = (GLushort) (*loc_text_attr.pb_string);

    /* First cross of the string to prepare the characters decorations and dimensions */
    while (loc_text_attr.ui_counter > 0) {

        switch (loc_text_attr.us_index) {
        case SGL_K_ESC:
        {
            loc_text_attr.ui_counter--;
            loc_text_attr.pb_string++;
            loc_text_attr.us_index = (GLushort) (*loc_text_attr.pb_string);
            ...
            case SGL_K_FONT:
            {
                ...
                loc_text_attr.pb_string++;
                loc_text_attr.us_index = (GLushort) (*loc_text_attr.pb_string);
                oglxSelectFont((SGLulong) (loc_text_attr.us_index));
                loc_text_attr.ui_current_font_id = glob_pr_sglStatemachine->ui_current_font_id;
                loc_text_attr.p_current_font = glob_pr_sglStatemachine->p_current_font;
                loc_text_attr.ui_counter--;
                loc_text_attr.pb_string++;
            ...
            case SGL_K_REPEAT_BEG:
            {
                loc_text_attr.ui_counter--;
                loc_text_attr.pb_string++;
                loc_us_repeat_number = (GLushort) (*loc_text_attr.pb_string);
                loc_text_attr.ui_counter--;
                loc_text_attr.pb_string++;
                loc_pb_repeat_string = loc_text_attr.pb_string;
                loc_ui_repeat_counter = (SGLulong) (loc_text_attr.ui_counter);
                loc_text_attr.us_index = (GLushort) (*loc_text_attr.pb_string);
            }
                break;
            case SGL_K_REPEAT_END:
            {
                loc_text_attr.ui_counter--;
                loc_text_attr.pb_string++;
                if (loc_us_repeat_number > 0U) {
                    loc_us_repeat_number--;
                    loc_text_attr.ui_counter = (GLint) loc_ui_repeat_counter;
                    loc_text_attr.pb_string = loc_pb_repeat_string;
                }
                else {
                    /* Nothing to do */
                }
        ...
        case SGL_K_CR:
        {
            loc_text_attr.ui_counter--;
            loc_text_attr.pb_string++;
            loc_f_tx = -par_f_hor_alignment * loc_text_attr.f_width;
            if (loc_b_first_bounds_value) {
                loc_f_min_x = loc_f_x + loc_f_tx;
                loc_f_max_x = loc_f_x + loc_f_tx + loc_text_attr.f_width;
                ...
                if (loc_f_max_x < (loc_f_x + loc_f_tx + loc_text_attr.f_width)) {
                    loc_f_max_x = loc_f_x + loc_f_tx + loc_text_attr.f_width;
                }
                else {
                    /* Nothing to do */
        ...
        default:
        {
            oglx_compute_character_bounds(&loc_text_attr);
        }
            break;
        }
    }
    ...
    if (loc_text_attr.us_line_number == 0U) {
        loc_f_ty = -(par_f_vert_alignment * loc_text_attr.f_height);
    }
    else {
        loc_f_ty = -(par_f_vert_alignment * loc_text_attr.f_height)
            + (((1.0F - par_f_vert_alignment) * (loc_text_attr.f_height + (loc_text_attr.f_max_vert_advance))) *
               (SGLfloat) (loc_text_attr.us_line_number));
    }
    loc_f_y += loc_f_ty;

    loc_s_return.f_min_x = loc_f_min_x;
    loc_f_tmp = ((loc_text_attr.f_height + loc_text_attr.f_max_vert_advance) * (SGLfloat) (loc_text_attr.us_line_number));
    loc_s_return.f_min_y = loc_f_y - (loc_text_attr.f_max_vert_advance + loc_f_tmp);
    loc_s_return.f_max_x = loc_f_max_x;
    loc_s_return.f_max_y = loc_f_y + (loc_text_attr.f_height + (2.0F * loc_f_ratio_y));
...
/*+ FUNCTION DESCRIPTION ----------------------------------------------
  ...
  RETURN:
    sgl_bounding_box -> the computed bounding box
---------------------------------------------------------------------+*/
sgl_bounding_box oglxGetRichTextBounds(SGLfloat par_f_x, SGLfloat par_f_y, SGLulong par_ui_font_identifier, const SGLbyte * par_pb_string,
                                       SGLulong par_ui_string_length, SGLfloat par_f_hor_alignment, SGLfloat par_f_vert_alignment)
{
    ...
    while ((!loc_b_end_of_string) && (loc_par_ui_string_length < loc_ui_param_length)) {
        if (loc_pb_string[loc_par_ui_string_length] == 0U) {
            if (loc_par_ui_string_length >= 2U) {
                if ((((loc_pb_string[loc_par_ui_string_length - 1UL]) == SGL_K_FONT)
                     || ((loc_pb_string[loc_par_ui_string_length - 1UL]) == SGL_K_FORECOLOR)
                     || ((loc_pb_string[loc_par_ui_string_length - 1UL]) == SGL_K_BACKCOLOR)
                     || ((loc_pb_string[loc_par_ui_string_length - 1UL]) == SGL_K_REPEAT_BEG))
                    && ((loc_pb_string[loc_par_ui_string_length - 2UL]) == SGL_K_ESC)) {
    ...
    return oglx_get_rich_text_bounds(par_f_x, par_f_y, par_pb_string, loc_par_ui_string_length, par_f_hor_alignment, par_f_vert_alignment);
}
                                      ...
                                      SGLlong par_l_hor_alignment, SGLlong par_l_vert_alignment)
{
    ...
    if (!loc_b_error_detected) {
        ...
        loc_s_return =
            oglxGetRichTextBounds(par_f_x, par_f_y, (SGLulong) par_l_font_id, par_pb_string, (SGLulong) par_l_string_length,
