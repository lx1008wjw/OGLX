/** FILE DESCRIPTION -------------------------------------------------------
 FILENAME          : mth_next_higher_power2.c
...
/*+ DEFINITION OF CONSTANTS -------------------------------------------------------
 DESCRIPTION       : Definition of constants of mth_next_higher_power2.c
 LLR: [OGLX-DDD-mth_next_higher_power2_constants]
---------------------------------------------------------------------------- +*/
...
SGLlong mth_next_higher_power2(SGLlong par_l_val, SGLlong par_l_min_pow2, SGLlong par_l_max_pow2)
{
    ...
    if ((par_l_val < 0) || (par_l_min_pow2 < 0) || (par_l_max_pow2 < 0)
        ...
        if (par_l_val <= par_l_min_pow2) {
            ...
            loc_ul_k = (loc_ul_k >> 1U) | loc_ul_k;
            loc_ul_k = (loc_ul_k >> 2U) | loc_ul_k;
            loc_ul_k = (loc_ul_k >> 4U) | loc_ul_k;
            loc_ul_k = (loc_ul_k >> 8U) | loc_ul_k;
            loc_ul_k = (loc_ul_k >> 16U) | loc_ul_k;
            loc_ul_k += 1U;
        }
