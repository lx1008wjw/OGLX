...
/*+ DEFINITION OF TYPES -------------------------------------------------------
 DESCRIPTION       : Definition of types of mth.h
 LLR: [OGLX-DDD-mth_types]
---------------------------------------------------------------------------- +*/
typedef struct {
    SGLfloat f_x;
    SGLfloat f_y;
...
/*+ DEFINITION OF CONSTANTS -------------------------------------------------------
 DESCRIPTION       : Definition of constants of mth.h
 LLR: [OGLX-DDD-mth_constants]
---------------------------------------------------------------------------- +*/
...
#define MTH_PI 3.1415926536F
#define MTH_180_OVER_PI 57.29578121F
...
extern SGLlong mth_f_to_l(SGLfloat par_f_value);
...
extern SGLfloat mth_acos(SGLfloat par_f_t);
...
extern SGLulong mth_strlen(const SGLushort par_pus_string[], SGLulong par_ul_max_string_length);

extern SGLfloat mth_get_min_value(SGLulong par_ul_nb_entries, const SGLfloat par_pf_values[]);

extern SGLfloat mth_get_max_value(SGLulong par_ul_nb_entries, const SGLfloat par_pf_values[]);

extern SGLfloat mth_norm(SGLfloat par_f_x1, SGLfloat par_f_y1, SGLfloat par_f_x2, SGLfloat par_f_y2);

extern SGLbool mth_point_in_shape(SGLfloat par_f_point_x, SGLfloat par_f_point_y, SGLulong par_ul_nb_points, SGLfloat par_pf_points[][2]);
