...
OGLXAPI SGLulong sglBeginMaskDefinition(SGLbyte par_b_visible);
...
OGLXAPI void sglEndMaskDefinition(void);
...
OGLXAPI void sglFreeMaskID(SGLulong par_ul_mask_combination);
...
OGLXAPI void sgluCrown2f(SGLfloat par_f_centerx, SGLfloat par_f_centery, SGLfloat par_f_radius, SGLfloat par_f_thickness,
...
OGLXAPI SGLdouble sgluDoubleDiv(SGLdouble par_d_double_1, SGLdouble par_d_double_2);
...
OGLXAPI SGLint32 sglUInt64ToInt32(SGLuint64 par_ul_value);
...
#ifndef OGLX_NO_64_BITS
OGLXAPI SGLuint32 sglInt64ToUInt32(SGLint64 par_l_value);
...
/*+ DEFINITION OF MACROS -------------------------------------------------------
 DESCRIPTION       : Definition of OGLX macros
 LLR: [OGLX-DDD-Macros]
---------------------------------------------------------------------------- +*/
...
#define SGLfloat_div(x,y) sgluFloatDiv((x),(y))
...
#define SGLdouble_div(x,y) sgluDoubleDiv((x),(y))
