...
/*+ DEFINITION OF CONTEXT TYPE -------------------------------------------------------
 ...
 LLR: [OGLX-DDD-sgl_type_statemachine]
---------------------------------------------------------------------------- +*/
...
typedef struct {
    SGLbool b_state_texture_2d;
    SGLbool b_state_blend;
    SGLbool b_state_stencil_test;
    SGLbool b_state_scissor_test;
    SGLbool b_state_depth_test;
...
*****************************************************************************/
    ...
    SGLbool b_overflow_flag;
/****************************************************************************/

/*****************************************************************************
** Pointers to resource tables
*****************************************************************************/
/* [color table] */
...
/*****************************************************************************
**	Textures and gradients application attributes
*****************************************************************************/
...
*****************************************************************************/
    ...
    /* Mask container definition */
    SGLulong ul_mask_definition;
...
/* Texture buffer used to convert texture and read fonts */
    SGLbyte *tub_texture_buffer;

/****************************************************************************/

/****************************************************************************
** Data to draw primitives
*****************************************************************************/
    SGLfloat f_line_loop_first_vertex_x;
    SGLfloat f_line_loop_first_vertex_y;
    SGLbool b_close_line_loop;
    SGLbool b_switch_to_sgl_lines;
...
/****************************************************************************
** OpenGL ES 2.0 and SC 2.0 attributes
*****************************************************************************/
    ...
    SGLlong i_clipPlane_active[SGL_MAX_CLIP_PLANES];
    SGLlong i_clipPlane_uniform[SGL_MAX_CLIP_PLANES];
...
#if defined(ES2_DEV_ENV) || defined(SC2_DEV_ENV)
    SGLbool b_change_viewport;

    SGLfloat f_prev_ortho_left;
    SGLfloat f_prev_ortho_right;
    SGLfloat f_prev_ortho_bottom;
    SGLfloat f_prev_ortho_top;

    SGLlong i_prev_x1;
    SGLlong i_prev_y1;
    SGLlong i_prev_width;
    SGLlong i_prev_height;
