...
/*+ DEFINITION OF TYPES -------------------------------------------------------
 DESCRIPTION       : Definition of fonts types and macros
 LLR: [OGLX-DDD-Font_Macros_Types]
---------------------------------------------------------------------------- +*/
#ifndef _GLF_H
#define _GLF_H
...
#define GLF_LINES               SGL_LINES
#define GLF_LINE_STRIP          SGL_LINE_STRIP
#define GLF_LINE_LOOP           SGL_LINE_LOOP
